...
# 10. Start Nginx (but don't enable HTTPS redirect yet)
echo "Step 10: Starting Nginx..."
# Temporarily disable HTTPS redirect for initial setup
sudo sed -i 's/return 301/#return 301/' /etc/nginx/sites-available/stirling-pdf
...
echo "NEXT STEPS:"
echo ""
echo "1. Get your GCP External IP:"
echo "   - Go to GCP Console → VM Instances"
echo "   - Copy the 'External IP' address"
echo ""
echo "2. Add DNS Record in Hostinger:"
echo "   - Type: A"
echo "   - Name: pdf-api"
echo "   - Points to: <Your-GCP-External-IP>"
echo "   - TTL: 14400"
echo ""
echo "3. Wait 5-10 minutes for DNS propagation"
echo ""
echo "4. Run SSL setup (once DNS is ready):"
echo "   sudo certbot --nginx -d pdf-api.ocr-extraction.com"
echo ""
echo "5. Enable HTTPS redirect:"
echo "   sudo sed -i 's/#return 301/return 301/' /etc/nginx/sites-available/stirling-pdf"
