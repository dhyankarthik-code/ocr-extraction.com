...
export default function ImageCropper({ imageSrc, onCropComplete, onCancel }: ImageCropperProps) {
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-black/90 flex flex-col items-center justify-center p-4">
            <div className="relative w-full max-w-4xl h-[70vh] flex items-center justify-center overflow-auto rounded-xl">
                <ReactCrop
                    crop={crop}
            ...
            {/* Controls Overlay */}
            <div className="absolute bottom-0 left-0 w-full bg-black/80 backdrop-blur-md p-4 flex flex-col items-center gap-4">
                <div className="flex items-center gap-4 w-full max-w-md">
                    <span className="text-white text-xs font-medium w-12">Rotate</span>
                    <Slider
                        value={[rotation]}
                        min={0}
                        max={360}
