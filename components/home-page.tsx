...
export default function HomePage() {
    ...
    return (
        <div ref={heroRef} className="flex flex-col items-center justify-start pt-4 pb-6 w-full premium-gradient" data-hydrated={mounted} data-deploy-id="811ca08-v5">
            <div className="text-center w-full max-w-4xl px-4 mb-6">
                <div className="text-3xl md:text-5xl font-bold text-gray-900 mb-4 text-balance text-premium-gradient">
                    {/* SEO H1 (Visually Hidden but accessible to crawlers) */}
                    <h1 className="text-gray-900 text-center relative w-full min-h-[4rem] md:min-h-[6rem] flex items-center justify-center">
                ...
                <h2 className="text-lg md:text-xl font-bold text-red-600 tracking-tight uppercase mb-3">
