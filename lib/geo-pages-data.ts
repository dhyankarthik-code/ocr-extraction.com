...
export const geoPages: Record<string, CountryPageData> = {
    'saudi-arabia': {
        ...
        marketContext: 'Saudi Arabia\'s Vision 2031 has committed over $6.4 billion to AI and digital transformation. NEOM, the $500B mega-city project, is one of the largest AI infrastructure projects in human history. Every major Saudi enterprise — from Saudi Aramco to STC and SABIC — is now building dedicated AI teams.',
        ...
        localIndustries: ['Oil & Gas (Aramco, SABIC)', 'Telecommunications (STC, Mobily)', 'Financial Services (Al Rajhi, SNB)', 'Real Estate & Smart Cities (NEOM, ROSHN)', 'Healthcare (MOH Digital Transformation)', 'Retail & E-commerce'],
        ...
        faqs: [
            { q: 'Can you provide AI engineers for Vision 2031 projects in Saudi Arabia?', a: 'Yes. We have deployed AI engineers for government-backed and private sector Vision 2031 projects. Our engineers have experience in Arabic NLP, smart city data platforms, and oil/gas predictive analytics relevant to the KSA market.' },
    ...
    'uae': {
        ...
        marketContext: 'The UAE is the Arab world\'s most aggressive AI investor, with the UAE National AI Strategy 2031 targeting 13.6% GDP contribution from AI. Dubai\'s DIFC and Abu Dhabi\'s ADGM are now global fintech AI hubs. The UAE\'s Ministry of AI — the world\'s first — signals the government\'s unmatched commitment to the technology.',
        ...
        localIndustries: ['Financial Services (DIFC, ADGM Fintechs)', 'Real Estate PropTech (Emaar, Damac)', 'Logistics (DP World, Etihad Cargo)', 'Healthcare (Cleveland Clinic Abu Dhabi)', 'E-commerce & Retail', 'Smart Government Initiatives'],
        ...
        faqs: [
            { q: 'Can you provide AI engineers for UAE government and DIFC projects?', a: 'Yes. We have deployed engineers for UAE fintech, PropTech, and government AI initiatives. Our teams are experienced in UAE PDPL compliance and can work within DIFC/ADGM regulatory frameworks.' },
    ...
    'usa': {
        ...
        whyRemote: 'A US-based AI team of 5 costs ~$1.5M/year all-in. The same calibre remote team through InfyGalaxy costs $300k–400k/year — freeing $1M+ in capital to ship more product. 73% of Y Combinator-backed startups now use offshore AI teams for this reason.',
        localIndustries: ['SaaS & Cloud Platforms', 'Fintech & Banking (JPMorgan, Stripe)', 'Healthcare AI (Epic, Flatiron)', 'E-commerce (Amazon Marketplace Sellers)', 'Defence & Government AI', 'Media & Entertainment AI'],
        salaryLocal: '$220,000 – $350,000/year + equity + benefits',
        salaryRemote: '$60,000 – $100,000/year',
        hourlyRate: '$40 – $80/hr',
        timezone: 'EST/PST (UTC-5 to UTC-8)',
        timezoneOverlap: 'Engineers on EST/IST overlap shifts provide 4–6 hrs real-time collaboration daily',
    ...
    'united-kingdom': {
        ...
        localIndustries: ['FinTech (Monzo, Revolut, Wise)', 'Health Tech (NHS AI Labs, Babylon)', 'Legal Tech & RegTech', 'Retail AI (Ocado, ASOS)', 'Media & AdTech (ITV, WPP)', 'Defence & GovTech'],
        ...
        faqs: [
            ...
            { q: 'Do you work with UK FinTech companies regulated by the FCA?', a: 'Yes. We have deployed AI engineers for FCA-regulated FinTechs. Our teams are experienced in explainable AI (XAI) for credit decisions, fraud detection, and AML — all areas requiring regulatory alignment.' },
        ],
    },
    ...
    'germany': {
        ...
        heroSubtitle: 'Build your AI team for German Mittelstand and DAX companies. GDPR-native engineers, German work-week ready, at 65% below local rates.',
        ...
        marketContext: 'Germany is Europe\'s industrial AI powerhouse. The German government\'s AI Strategy commits €3 billion to AI development, with a focus on manufacturing, automotive, and healthcare. Companies like Siemens, BMW, SAP, and Deutsche Bank are building massive AI teams — but Germany\'s strict labour laws and premium salaries create a significant cost barrier.',
        ...
        localIndustries: ['Automotive AI (BMW, Mercedes, VW)', 'Industrial IoT (Siemens, Bosch)', 'Enterprise Software (SAP)', 'Financial Services (Deutsche Bank, Allianz)', 'Healthcare (Bayer, Fresenius)', 'E-commerce (Zalando, OTTO)'],
    ...
    'singapore': {
        ...
        heroSubtitle: 'Power your Singapore AI projects with top 1% remote talent. PDPA-aware engineers serving SGX-listed firms, MAS-regulated fintechs, and smart city initiatives.',
        ...
        marketContext: 'Singapore is APAC\'s undisputed AI hub. The National AI Strategy 2.0 commits S$1 billion over five years, with focus on government AI, fintech, and smart nation initiatives. Singapore hosts APAC headquarters of Alibaba Cloud, Google, and Microsoft — creating fierce competition for AI talent and pushing local salaries to near-Western levels.',
        ...
        localIndustries: ['Financial Services (MAS-regulated fintechs, DBS, UOB)', 'Government & Smart Nation (GovTech)', 'Logistics & Supply Chain (PSA, DHL APAC HQ)', 'Healthcare AI (MOH, IHH)', 'Digital Media & Gaming', 'Legal Tech & RegTech'],
    ...
    'india': {
        ...
        marketContext: 'India produces approximately 40% of the world\'s AI talent and hosts R&D centres for Google, Microsoft, Amazon AWS, and NVIDIA. Bengaluru\'s AI ecosystem rivals Silicon Valley for depth of talent in ML, GenAI, and MLOps. India\'s NASSCOM estimates 1 million+ AI-skilled professionals — the deepest available pool on earth.',
        whyRemote: 'Hiring directly through InfyGalaxy gives you access to the real top 1% — engineers who have built systems at scale for Fortune 500 and fast-growth startups — not freelancer-platform generalists. We handle all HR, payroll, and compliance, so you get a dedicated engineer without setting up a legal entity in India.',
        localIndustries: ['SaaS Products (Freshworks, Zoho, Razorpay)', 'IT Services (TCS, Infosys, Wipro AI labs)', 'Fintech (Paytm, PhonePe AI teams)', 'Healthcare AI (Apollo, Practo)', 'EdTech (BYJU\'S AI)', 'E-commerce AI (Flipkart, Meesho)'],
        ...
        complianceNote: 'Indian AI projects fall under the upcoming DPDP Act 2023 (Digital Personal Data Protection Act). Our contracts include DPDP-aligned data processing terms. IP ownership is fully transferred to clients via signed agreements.',
        stats: [
            { label: 'India AI Talent Pool', value: '1M+' },
            { label: 'World AI Talent Share', value: '40%' },
            { label: 'Avg Senior AI Salary', value: '$45k/yr' },
            { label: 'Global Fortune 500 India R&D', value: '400+' },
        ],
        faqs: [
